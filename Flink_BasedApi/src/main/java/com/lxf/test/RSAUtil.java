...
public class RSAUtil {
    public static void main(String[] args) throws Exception {
        ...
        //加密字符串
        String message = "Wve2vmMg8xxofCe/zgEuhVWqnB/uNT6A+JnJKIjuvJM=";
        System.out.println("base64编码后的随机生成的公钥为:" + keyMap.get(0));
        System.out.println("base64编码后的随机生成的私钥为:" + keyMap.get(1));

        // 加密
        String encryptStr = encrypt(message, keyMap.get(0));
        System.out.println("base64编码后的RSA加密后秘文:"+encryptStr);

        // 解密
        String decrypt = decrypt(encryptStr, keyMap.get(1));
        System.out.println("RSA解密后明文:"+decrypt);
    }
    ...
    public static String decrypt(String encryptStr, String privateKey) throws Exception{
        ...
        String outStr = new String(cipher.doFinal(encryptBytes));
        return outStr;
    }
}
